...
public class RandomShinyRegularToken extends SpawnTokens {

    public RandomShinyRegularToken(){
        this.name = TokenTypes.TokenName.randomShinyNonSpecial;
    ...
    public List<Text> info() {
        return Arrays.asList(
                Text.of(TextColors.DARK_PURPLE,"Right-click item to receive a shiny non-special pokemon"),
